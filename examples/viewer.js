...
async function startViewer(localView, remoteView, formValues, onStatsReport, credential, onRemoteDataMessage) {
    try {
        ...
        formValues.accessKeyId = "AKIA6ODU6URYBITH4NNK";
        formValues.secretAccessKey = "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";
       // formValues.sessionToken = credential.sessionToken;
        // formValues.channelName = '3C62F019B206-2305DMM000059';
        formValues.channelName = "ojo-mosolabs-all-540p-h264";
